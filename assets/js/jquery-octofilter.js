;(function($) {
  ...
  Octofilter.prototype.select = function(value) {
    ...
    var $filterLabel = $('<span/>', { 'name' : 'jobSelects',  'class': 'octofilter-label', text: $filter.text(), 'data-value': value, 'data-category': category });
...
//   $(".nav-tabs li").focus(function(){
//     $(this).css("background-color", "#F9A277");
// });
