    ...
    $.extend(Wickedpicker.prototype, {
        ...
        showPicker: function (element) {
            ...
            this.timepicker.css({
                ...
                position: 'absolute',
                left: (timepickerPos.left + ($(element).outerWidth()) - (this.timepicker.outerWidth())),
        ...
        createPicker: function () {
            if ($('.wickedpicker').length === 0) {
                var picker = '<div class="wickedpicker"><p class="wickedpicker__title">' + this.options.title + '<span class="wickedpicker__close"></span></p><ul class="wickedpicker__controls"><li class="wickedpicker__controls__control"><i class="' + this.options.upArrow + '"></i><span class="wickedpicker__controls__control--hours" tabindex="-1">00</span><i class="' + this.options.downArrow + '"></i></li><li class="wickedpicker__controls__control--separator"><span class="wickedpicker__controls__control--separator-inner">:</span></li><li class="wickedpicker__controls__control"><i class="' + this.options.upArrow + '"></i><span class="wickedpicker__controls__control--minutes" tabindex="-1">00</span><i class="' + this.options.downArrow + '"></i></li>';
                if (this.options.showSeconds) {
                    picker += '<li class="wickedpicker__controls__control--separator"><span class="wickedpicker__controls__control--separator-inner">:</span></li><li class="wickedpicker__controls__control"><i class="' + this.options.upArrow + '"></i><span class="wickedpicker__controls__control--seconds" tabindex="-1">00</span><i class="' + this.options.downArrow + '"></i> </li>';
                }
                picker += '<li class="wickedpicker__controls__control"><i class="' + this.options.upArrow + '"></i><span class="wickedpicker__controls__control--meridiem" tabindex="-1">AM</span><i class="' + this.options.downArrow + '"></i></li></ul></div>';
                $('body').append(picker);
